...
interface MemberServiceClient {
    ...
    fun startOnboardingWithSSN(@PathVariable memberId: Long, @RequestBody body: StartOnboardingWithSSNRequest): ResponseEntity<Unit>

    @PostMapping("/_/member/{memberId}/finalizeOnboarding")
    fun finalizeOnboarding(@PathVariable memberId: Long, @RequestBody body: UpdateContactInformationRequest): ResponseEntity<Unit>
